...
![Windows Event Viewer Filtered Logs] 
<img width="1366" height="676" alt="SOC5" src="https://github.com/user-attachments/assets/7bc11ab2-c1ac-43d3-906c-600c58f79b12" />


Legacy tools like Microsoft `LogParser.exe` often encounter syntax and parsing issues with modern `.evtx` binary formats.

![Legacy LogParser Syntax Testing] 
<img width="1366" height="719" alt="SOC4" src="https://github.com/user-attachments/assets/88fbbc96-55ac-422a-ac56-51ba0e88030d" />
...
![PowerShell Log Extraction Script] 
<img width="1337" height="636" alt="SOC8" src="https://github.com/user-attachments/assets/89d432a1-d3e4-4a7c-9024-43a96bed9062" />


The extracted output was verified directly from the terminal to ensure complete telemetry collection.

![Terminal CSV Verification] 
<img width="460" height="589" alt="SOC9" src="https://github.com/user-attachments/assets/85bbd481-fc96-43eb-92b8-e7533918fad8" />
...
<img width="1234" height="650" alt="SOC10" src="https://github.com/user-attachments/assets/a449bf20-4a91-4919-96ab-ba0fd921e9e7" />
...
![HTML Summary Generation Script] 
<img width="1304" height="570" alt="SOC12" src="https://github.com/user-attachments/assets/56c35841-39e0-4be7-85e3-6d855f3cc0e9" />


The finalized report formats telemetry into a readable audit document.

![Final Human-Readable HTML Report] 
<img width="564" height="498" alt="SOC11" src="https://github.com/user-attachments/assets/c288afe0-847c-4c5d-8afe-e2847c2a7d65" />
